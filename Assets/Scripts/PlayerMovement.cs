...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _playerInputActions.Player.MoveUp.performed += MoveInput;
        _playerInputActions.Player.MoveDown.performed += MoveInput;
        _playerInputActions.Player.MoveLeft.performed += MoveInput;
        _playerInputActions.Player.MoveRight.performed += MoveInput;

        _playerInputActions.Player.MoveUp.canceled += MoveInput;
        _playerInputActions.Player.MoveDown.canceled += MoveInput;
        _playerInputActions.Player.MoveLeft.canceled += MoveInput;
        _playerInputActions.Player.MoveRight.canceled += MoveInput;

        _playerInputActions.Player.A.performed += PlantBomb;
    }
